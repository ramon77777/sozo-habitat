<div class="w-full max-w-5xl rounded-2xl bg-white/15 p-4 backdrop-blur-xl shadow-2xl">
    <form method="GET" action="<?php echo e(route('properties.index')); ?>" class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <input
            type="text"
            name="city"
            placeholder="Ville"
...
</div><?php /**PATH D:\laragon\www\sozo-habitat\resources\views/components/search-box.blade.php ENDPATH**/ ?>