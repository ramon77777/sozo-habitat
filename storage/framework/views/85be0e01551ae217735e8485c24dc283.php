            ...
            <form method="POST" action="<?php echo e(route('admin.properties.store')); ?>" enctype="multipart/form-data">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" class="w-full border border-slate-200 rounded-xl p-4">
                    </div>

                    <div>
                        <label class="block mb-2 font-semibold">Prix (FCFA)</label>
                        <input type="number" name="price" class="w-full border border-slate-200 rounded-xl p-4">
                    </div>

                    <div>
                        <label class="block mb-2 font-semibold">Ville</label>
                        <input type="text" name="city" class="w-full border border-slate-200 rounded-xl p-4">
                    </div>

                    <div>
                        <label class="block mb-2 font-semibold">Commune</label>
                        <input type="text" name="district" class="w-full border border-slate-200 rounded-xl p-4">
                    </div>

                    <div class="md:col-span-2">
                        <label class="block mb-2 font-semibold">Adresse / Quartier / Indication</label>
                        <input type="text" name="address" class="w-full border border-slate-200 rounded-xl p-4">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="surface" class="w-full border border-slate-200 rounded-xl p-4">
                    </div>
                    ...
                    <div id="housingFields" class="md:col-span-2">
                        <div class="grid md:grid-cols-5 gap-6">
                            <div>
                                ...
                                <input type="number" name="bedrooms" class="w-full border border-slate-200 rounded-xl p-4">
                            </div>

                            <div>
                                <label class="block mb-2 font-semibold">Salles d'eau</label>
                                <input type="number" name="bathrooms" class="w-full border border-slate-200 rounded-xl p-4">
                            </div>

                            <div>
                                <label class="block mb-2 font-semibold">Salons</label>
                                <input type="number" name="living_rooms" class="w-full border border-slate-200 rounded-xl p-4">
                            </div>

                            <div>
                                <label class="block mb-2 font-semibold">Cuisines</label>
                                <input type="number" name="kitchens" class="w-full border border-slate-200 rounded-xl p-4">
                            </div>

                            <div>
                                <label class="block mb-2 font-semibold">Garages</label>
                                <input type="number" name="garages" class="w-full border border-slate-200 rounded-xl p-4">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="landFields" class="hidden md:col-span-2">
                        <div class="grid md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="document_type" placeholder="ACD, CPF..." class="w-full border border-slate-200 rounded-xl p-4">
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="file" name="main_image" accept="image/jpeg,image/png,image/webp" class="w-full border border-slate-200 rounded-xl p-4">
                    </div>
                ...
                <div class="mt-6">
                    ...
                    <textarea name="description" rows="6" class="w-full border border-slate-200 rounded-xl p-4"></textarea>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\sozo-habitat\resources\views/admin/properties/create.blade.php ENDPATH**/ ?>